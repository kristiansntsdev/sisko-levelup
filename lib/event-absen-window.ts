/** Online self-absen opens 15 minutes before jam selesai, closes at jam selesai. */
...
if (process.env.NODE_ENV !== 'production') {
  ...
  const { opensAt } = getOnlineAbsenWindow(end)
  ...
  console.assert(isOnlineAbsenOpen(new Date('2026-08-21T20:00:00'), end), 'open at end')
  console.assert(!isOnlineAbsenOpen(new Date('2026-08-21T19:44:59'), end), 'closed before window')
  console.assert(!isOnlineAbsenOpen(new Date('2026-08-21T20:00:01'), end), 'closed after end')
